...
[![R-CMD-check](https://github.com/ropensci/cffr/actions/workflows/check-full.yml/badge.svg)](https://github.com/ropensci/cffr/actions/workflows/check-full.yml)
...
As per 2026-02-17 there are at least 486 repos on GitHub using **cffr**.
[Check them out
...
#> ✔ Installing ./.github/workflows/update-citation-cff.yml
#> ℹ Adding ".github" to .Rbuildignore
```

See the example workflow file
[here](https://github.com/ropensci/cffr/blob/main/.github/workflows/update-citation-cff.yml).
