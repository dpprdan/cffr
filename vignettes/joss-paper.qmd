...
[@salmon2021] . Among many reasons why software is not cited, one is the lack of
a clear citation information from package developers.
...
the metadata already included in the package. Additionally, the package also
includes validation tools via the jsonvalidate package [@jsonvalidate2021], that
